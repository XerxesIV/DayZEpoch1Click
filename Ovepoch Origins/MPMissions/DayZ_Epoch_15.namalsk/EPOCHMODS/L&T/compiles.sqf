if (!isDedicated) then {
	...
	call compile preprocessFileLineNumbers "EpochMods\L&T\config.sqf";
	call compile preprocessFileLineNumbers format ["EpochMods\L&T\lang\%1_lang.sqf", LOG_CFG_lANG];

	MONI_OBJECT	= compile preprocessFileLineNumbers "EpochMods\L&T\monitor\monitor_object.sqf";
	MONI_ACTION	= compile preprocessFileLineNumbers "EpochMods\L&T\monitor\monitor_action.sqf";
	LOG_OBJ_INIT = compile preprocessFileLineNumbers "EpochMods\L&T\object\init.sqf";
	LOG_LIFT_INIT = compile preprocessFileLineNumbers "EpochMods\L&T\lift\init.sqf";
	LOG_TOW_INIT = compile preprocessFileLineNumbers "EpochMods\L&T\tow\init.sqf";
