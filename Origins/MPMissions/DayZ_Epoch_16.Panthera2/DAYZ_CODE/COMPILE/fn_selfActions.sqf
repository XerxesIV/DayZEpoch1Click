		...
		if (s_player_parts_crtl < 0) then {
			...
			if(_humanity_logic) then {
				...
				// Static Menu
				{
					...
					_buy = player addAction [format["Trade %1 %2 for %3 %4",(_x select 3),(_x select 5),(_x select 2),(_x select 6)], "DAYZ_CODE\ACTIONS\trade_items_wo_db.sqf",[(_x select 0),(_x select 1),(_x select 2),(_x select 3),(_x select 4),(_x select 5),(_x select 6)], (_x select 7), true, true, "",""];
