...
if(isNil "DZE_CLICK_ACTIONS_BUILD") then {
    ...
    call compile preprocessFileLineNumbers "EpochMods\ClickActions\config.sqf";
    player_selectSlot = compile preprocessFileLineNumbers "EpochMods\ClickActions\ui_selectSlot.sqf";
